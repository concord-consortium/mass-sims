...
test.describe("Multi-trial", () => {
  ...
  // Scenario 3: per-trial selectedCross memory survives switching away and back (MAS-13).
...
test.describe("Keyboard navigation in the Trials panel", () => {
  // Scenario 8: roving tabindex — Arrow moves focus AND selection (WAI-ARIA tabs pattern, MAS-13);
